...
const HeroSection = () => {
  return (
    <section 
      id="home" 
      className="pt-28 pb-16 md:pt-40 md:pb-24 px-4 bg-gradient-to-b from-ats-white to-ats-paleblue"
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 text-center md:text-left mb-10 md:mb-0">
          <div className="mb-6">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-ats-navy leading-tight">
              <span className="text-ats-blue">ATS Packers & Movers</span> — Safe, Fast, Reliable Relocation Services
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <Button variant="outline" className="border-ats-blue text-ats-blue hover:bg-ats-blue hover:text-ats-white">
                Learn More
              </Button>
            </div>
          </div>
